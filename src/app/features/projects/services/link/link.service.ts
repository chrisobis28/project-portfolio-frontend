...
export class LinkService {
  ...
  addRemovedLinkToRequest(requestId: string, linkId: string): Observable<Link> {
    return this.httpClient.put<Link>(this.API_URL + "request/remove/" + `${requestId}` + "/" + `${linkId}`, null)
  }
