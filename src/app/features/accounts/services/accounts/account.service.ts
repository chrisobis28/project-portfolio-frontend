...
import { AccountTransfer, ProjectTransfer, RoleInProject } from '../../models/accounts-models';
...
export class AccountService {
  ...
  addRoleOnProject(username: string, projectId: string, roleInProject: RoleInProject): Observable<any> {
